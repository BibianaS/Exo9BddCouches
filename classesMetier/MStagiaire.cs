...
namespace classesMetier
{
    ...
    abstract public class MStagiaire
    {
        ...
        /// </summary>
        private Int32 pointsNotes;

        /// <summary>
        /// obtient le nombre de points du stagiaire
        /// </summary>
        public Int32 PointsNotes
        {
        ...
        public void RecevoirNote(Int32 laNote)
        {
            this.nbreNotes++;
        ...
        public void SetPoints(Int32 desPoints, Int32 desNotes, String  undemandeur)
        {
            if (undemandeur == "ClassDAO.MStagiaireDAOEFStatic")
            {
        ...
        public Int32 GetNotes (String leDemandeur)
        {
            if (leDemandeur == "ClassDAO.MStagiaireDAOEFStatic")
            {
                return this.NbreNotes;
            }
            else
            {
                throw new Exception("Violation d'accès aux notes");
            }
           

        }

        public Int32 GetPoints (String leDemandeur)
        {
            if (leDemandeur == "ClassDAO.MStagiaireDAOEFStatic")
            {
                return this.PointsNotes;
            }
            else
            {
                throw new Exception("Violation d'accès aux notes");
